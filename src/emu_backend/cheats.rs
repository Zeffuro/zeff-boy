...
mod tests {
    ...
    fn gb_ram_cheats_resolve_masked_values() {
        ...
        backend.gb_mut().unwrap().emu.write_byte(0xC000, 0xA5);
    ...
    fn nes_ram_cheats_check_existing_value_and_resolve_masked_values() {
        ...
        backend.nes_mut().unwrap().emu.cpu_write(0x0000, 0x11);
        ...
        backend.nes_mut().unwrap().emu.cpu_write(0x0000, 0xA5);
        backend.apply_ram_cheats(&[CheatPatch::RamWrite {
            address: 0x0000,
            value: CheatValue::PreserveWithCurrent {
                mask: 0xF0,
    ...
    fn gba_wide_ram_cheats_write_cpu_address_space() {
        ...
        backend.gba_mut().unwrap().emu.cpu_write8(0x0200_0000, 0x01);
    ...
    fn ws_wide_ram_cheats_write_cpu_address_space() {
        ...
        backend.ws_mut().unwrap().emu.cpu_write8(0x0000_1234, 0x01);
    ...
    fn wide_conditional_ram_cheats_check_existing_value() {
        ...
        gba.gba_mut().unwrap().emu.cpu_write8(0x0200_0000, 0x01);
        ws.ws_mut().unwrap().emu.cpu_write8(0x0000_1234, 0x01);
    ...
    fn sega8_ram_cheats_write_cpu_address_space() {
        ...
        backend.sega8_mut().unwrap().emu.cpu_write8(0xC123, 0x01);
