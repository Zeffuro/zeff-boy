...
struct Fixture {
    ...
    disc_sha256: [u8; 32],
    arcade_catalog: crate::emu_backend::pce_profiles::TestArcadeCardCatalogGuard,
...
#[test]
fn direct_cue_arcade_multitap_binds_identity_and_native_start_state() -> Result<()> {
    let Fixture {
        directory,
        loader,
        arcade_catalog: _arcade_catalog,
        controller_catalog: _controller_catalog,
        ..
    } = fixture_with_catalogs("pce-cd-tas-arcade-multitap-identity")?;
    ...
    assert_eq!(
        ...
        super::super::super::direct_pce_cd::direct_pce_multitap_cd_arcade_tas_sync_config_sha256()
    );
    assert_ne!(
        project.identity().sync_config_sha256,
...
#[test]
fn direct_cue_arcade_multitap_seeks_replays_and_reauthenticates_source() -> Result<()> {
    let Fixture {
        directory,
        loader,
        arcade_catalog: _arcade_catalog,
        controller_catalog: _controller_catalog,
        ..
    } = fixture_with_catalogs("pce-cd-tas-arcade-multitap-roundtrip")?;
...
#[test]
fn direct_cue_arcade_multitap_requires_both_catalog_witnesses_and_exact_route() -> Result<()> {
    let Fixture {
        directory,
        loader,
        disc_sha256,
        arcade_catalog,
        controller_catalog,
    } = fixture_with_catalogs("pce-cd-tas-arcade-multitap-catalogs")?;
    ...
    assert_eq!(
        ...
        super::super::super::direct_pce_cd::direct_pce_multitap_cd_ppf_arcade_tas_sync_config_sha256()
    );
