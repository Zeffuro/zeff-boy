...
pub(crate) fn arcade_sync_config_sha256() -> TasDigest {
    TasDigest::from_bytes(ARCADE_SYNC_CONFIGURATION)
}

pub(crate) fn memory_base_sync_config_sha256() -> TasDigest {
    TasDigest::from_bytes(MEMORY_BASE_SYNC_CONFIGURATION)
}
...
pub(crate) fn multitap_sync_config_sha256() -> TasDigest {
    TasDigest::from_bytes(MULTITAP_SYNC_CONFIGURATION)
}

pub(crate) fn arcade_multitap_sync_config_sha256() -> TasDigest {
    TasDigest::from_bytes(ARCADE_MULTITAP_SYNC_CONFIGURATION)
}

pub(crate) fn memory_base_multitap_sync_config_sha256() -> TasDigest {
    TasDigest::from_bytes(MEMORY_BASE_MULTITAP_SYNC_CONFIGURATION)
}
...
pub(crate) fn selected_arcade_multitap_sync_config_sha256() -> TasDigest {
    TasDigest::from_bytes(SELECTED_ARCADE_MULTITAP_SYNC_CONFIGURATION)
}

pub(crate) fn selected_memory_base_multitap_sync_config_sha256() -> TasDigest {
    TasDigest::from_bytes(SELECTED_MEMORY_BASE_MULTITAP_SYNC_CONFIGURATION)
}

pub(crate) fn ppf_sync_config_sha256() -> TasDigest {
    TasDigest::from_bytes(PPF_SYNC_CONFIGURATION)
}
...
pub(crate) fn source_identity(
    ...
    hasher.update(b"zeff-tas-pce-cd-rar-source:v1\0");
...
pub(crate) fn ppf_source_identity(
    ...
    let mut hasher = Sha256::new();
    hasher.update(b"zeff-tas-pce-cd-rar-ppf-source:v1\0");
