...
fn response_kind(response: &EmuResponse) -> &'static str {
    match response {
        ...
        EmuResponse::TasRepairSuspended { .. } => "TasRepairSuspended",
        EmuResponse::TasRepairSuspendRejected { .. } => "TasRepairSuspendRejected",
        EmuResponse::TasRepairOriginalResumed { .. } => "TasRepairOriginalResumed",
        EmuResponse::TasRepairOriginalDiscarded { .. } => "TasRepairOriginalDiscarded",
        EmuResponse::TasRepairRepairedWorkerCommitted { .. } => "TasRepairRepairedWorkerCommitted",
        EmuResponse::TasRepairRepairedWorkerDiscarded { .. } => "TasRepairRepairedWorkerDiscarded",
        EmuResponse::TasRepairActionRejected { .. } => "TasRepairActionRejected",
        EmuResponse::TasReadinessObserved { .. } => "TasReadinessObserved",
