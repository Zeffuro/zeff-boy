...
use crate::debug::common::{
    ApuChannelDebug, DebugSection, PaletteGroupDebug, PaletteRowDebug, RomInfoSection,
    WatchHitDisplay, WatchpointDisplay,
};
use crate::debug::{
    ApuDebugInfo, ConsoleGraphicsData, CpuDebugSnapshot, DisassemblyView, GbGraphicsData,
        ...
        watchpoints: info
            ...
            .map(|w| WatchpointDisplay {
                ...
                watch_type: match w.watch_type {
                    ...
                    zeff_gb_core::debug::WatchType::ReadWrite => {
                        crate::debug::WatchType::ReadWrite
                    }
                },
            })
            .collect(),
