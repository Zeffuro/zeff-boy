...
pub struct DebugInfo {
    ...
    pub breakpoint_hit_conditions: Vec<zeff_emu_common::debug::BreakpointHitCondition>,
    pub event_breakpoints: Vec<zeff_emu_common::debug::DebugEvent>,
    ...
    pub hit_event: Option<zeff_emu_common::debug::DebugEvent>,
