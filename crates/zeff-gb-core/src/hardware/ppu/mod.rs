...
pub struct PPU {
    ...
    mode3_obj_tile_row_latched_mask: u16,
    mode3_obj_tile_rows: [u8; 10],
    mode3_obj_completed_mask: u16,
...
impl PPU {
    pub fn new() -> Self {
        ...
        Self {
            ...
            mode3_obj_tile_row_latched_mask: 0,
            mode3_obj_tile_rows: [0; 10],
            mode3_obj_completed_mask: 0,
