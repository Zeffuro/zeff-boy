...
use libretro_harness::{HarnessConfig, PixelFormat, run_fixed_frames};
use std::env;
use std::error::Error;
use std::path::PathBuf;

const PCE_WIDTH: u32 = 640;
const PCE_HEIGHT: u32 = 480;
...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    println!("libretro C-ABI smoke passed: {pixel_format} {width}x{height} pitch {expected_pitch}");
    Ok(())
}
